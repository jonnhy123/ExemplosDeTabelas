...
public class ExecutaTabelaBase extends JFrame {
	...
	protected JButton btnApagarTodos;
	...
	public ExecutaTabelaBase() {
		...
		gbc_btnExcluirItem.insets = new Insets(0, 0, 0, 5);
		gbc_btnExcluirItem.gridx = 2;
		gbc_btnExcluirItem.gridy = 0;
		panel_1.add(btnExcluirItem, gbc_btnExcluirItem);
		
		btnApagarTodos = new JButton("Apagar todos");
		GridBagConstraints gbc_btnApagarTodos = new GridBagConstraints();
		gbc_btnApagarTodos.insets = new Insets(0, 0, 0, 5);
		gbc_btnApagarTodos.gridx = 3;
		gbc_btnApagarTodos.gridy = 0;
		panel_1.add(btnApagarTodos, gbc_btnApagarTodos);
		
		btnSpeed = new JButton("Speed");
		GridBagConstraints gbc_btnSpeed = new GridBagConstraints();
		gbc_btnSpeed.gridx = 4;
		gbc_btnSpeed.gridy = 0;
